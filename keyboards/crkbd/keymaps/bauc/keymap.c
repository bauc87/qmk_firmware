...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        KC_LCTL, LOWER, LCMD_T(KC_SPC),       KC_RCMD, RAISE, TD(TD_ALT)
                                      //|--------------------------|  |--------------------------|
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, XXXXXXX, KC_VOLU, KC_MUTE, XXXXXXX, XXXXXXX,                      MACRO1, XXXXXXX,   KC_UP,XXXXXXX, XXXXXXX, MACRO2,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, KC_VOLD, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, RSFT_T(KC_ENT),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LCTL, LOWER,  LCMD_T(KC_SPC),     KC_SPC,   RAISE, KC_RALT
                                      //`--------------------------'  `--------------------------'
  ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case MACRO1:
    if (record->event.pressed) {
            SEND_STRING("alexbalneo@gmail.com");
        } else {
