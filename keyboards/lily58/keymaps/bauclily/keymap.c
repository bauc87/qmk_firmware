...
[_LOWER] = LAYOUT(
  ...
  _______, _______, KC_VOLD, _______, _______, _______, _______, _______,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,   _______, _______, KC_PLUS, KC_LCBR,  KC_RCBR, KC_UNDS, KC_BSLS, KC_ENT,
                             _______, _______, _______,  _______, _______,  _______, _______, _______
),
