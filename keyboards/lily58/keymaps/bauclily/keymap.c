 ...
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |KC_ENT|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LOWER | LCMD | Alt  | /Space  /       \Space \  | RSFT | RCMD |RAISE |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  TD(TD_CAPLOCK),  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,    TD(TD_PC), KC_QUOT,
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                      LOWER, KC_LCMD,  KC_LALT, KC_SPC,   KC_SPC,   KC_RSFT,  KC_RCMD, RAISE
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * |      |      |vol up| mute |      |      |-------.    ,-------|      |      |  up  |      |      |      |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |LCTRL |      |vol do|      |      |      |-------|    |-------|      | left | down |right |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LOWER | LGUI | Alt  | /Space  /       \Space \  |BackSP| RGUI |RAISE |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `-------------------''-------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, 
  _______, _______, KC_VOLU, KC_MUTE, _______, _______,                   _______, _______, KC_UP, _______, _______, _______,
  KC_LCTRL, _______, KC_VOLD, _______, _______, _______, _______, _______,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
                             _______, KC_LCMD,  KC_LALT, KC_SPC,   KC_SPC,   KC_RSFT,  KC_RCMD, _______
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                     KC_EQL, KC_PIPE,  KC_GRAVE,   XXXXXXX, XXXXXXX, XXXXXXX,
  KC_LCTRL, _______, _______, _______, _______, _______,   _______, _______, KC_PLUS, KC_LCBR,  KC_RCBR, KC_UNDS, KC_BSLS, KC_ENT,
                             _______, KC_LCMD,  KC_LALT, KC_SPC,   KC_SPC,   KC_RSFT,  KC_RCMD, _______
),
